...
from chemprop.nn_utils import index_select_ND, get_activation_function, visualize_atom_attention
import math
...
class MPNEncoder(nn.Module):
    def __init__(self, args: Namespace, atom_fdim: int, bond_fdim: int):
        ...
        self.args = args
        self.attention = True #args.attention
    ...
    def forward(self,mol_graph: BatchMolGraph, features_batch=None, viz_dir: str=None) -> torch.FloatTensor:
